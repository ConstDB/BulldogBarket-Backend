...
export const deleteSavedListingService = async( buyerId: Types.ObjectId, listingId: Types.ObjectId) => {
    const savedListing = await SavedListingRepository.delete(buyerId, listingId);
    return savedListing;
}